...
export const standards: Record<Locale, StandardsDict> = {
  en: {
    ...
    adds: [
      ...
      {
        h: "Versions that stay readable",
        p: "There is no version field to fill in: a revised curriculum gets its own identifier, so a learner's older credential still resolves to what they actually studied.",
      },
    ],
  ...
  et: {
    ...
    adds: [
      ...
      {
        h: "Versioonid, mis jäävad loetavaks",
        p: "Täidetavat versioonivälja pole: uuendatud õppekava saab oma identifikaatori, nii et õppija vanem tunnistus viitab ikka sellele, mida ta tegelikult õppis.",
      },
    ],
    ...
    adds: [
      ...
      {
        h: "Versiot, jotka pysyvät luettavina",
        p: "Täytettävää versiokenttää ei ole: uudistettu opetussuunnitelma saa oman tunnisteensa, joten oppijan vanhempi tunnistus palautuu edelleen siihen, mitä hän todella opiskeli.",
      },
    ],
  ...
  de: {
    ...
    adds: [
      ...
      {
        h: "Versionen, die lesbar bleiben",
        p: "Es gibt kein Versionsfeld zum Ausfüllen: Ein überarbeitetes Curriculum erhält seine eigene Kennung, sodass der ältere Nachweis eines Lernenden weiterhin auf das verweist, was er tatsächlich studiert hat.",
      },
    ],
  ...
  fr: {
    ...
    adds: [
      ...
      {
        h: "Des versions qui restent lisibles",
        p: "Il n'y a aucun champ de version à remplir : un curriculum révisé reçoit son propre identifiant, de sorte que le titre antérieur d'un apprenant continue de correspondre à ce qu'il a réellement étudié.",
      },
    ],
